...
public class final_classlevel2 extends final_classlevel1 { // in this we cant extends the parent class because parentclass we gave final keyword in class level so its a final class
